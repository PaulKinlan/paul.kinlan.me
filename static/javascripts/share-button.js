class ShareButton extends HTMLElement{static get observedAttributes(){return["href","text"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(this._createTemplate());let a=this.shadowRoot;this.shareBtn=a.getElementById("share-btn"),this.overlay=a.getElementById("overlay"),this.url=a.getElementById("url"),this.copy=a.getElementById("copy"),this.android=a.getElementById("android")}_createTemplate(){const a=document.createDocumentFragment();let b=document.createElement("style");b.innerHTML=`:host {
      display: inline-flex;
    ...
    #url {
      width: 100%;
      padding: 0.5em 0.5em;
    }`;const c=document.createElement("button");c.id="share-btn",c.innerHTML='<slot><img src="https://storage.googleapis.com/material-icons/external-assets/v4/icons/svg/ic_share_black_24px.svg"></slot>';const d=document.createElement("div");return d.id="overlay",d.innerHTML=`
      <div id="urlbar">
