...
Un peu en arrière, j'ai créé un script `[waitForElement](/ waiting-for-an-element-be-created) qui ferait ... Je pensais être cool, mais il s'est avéré que j'utilisais incorrectement Promises .
