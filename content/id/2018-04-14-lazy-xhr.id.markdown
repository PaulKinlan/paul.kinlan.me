...
Sedikit kembali, saya membuat skrip `[waitForElement](/waiting-for-an-element-to-be-created)` yang akan ... Saya pikir saya sedang keren tapi ternyata saya menggunakan Janji dengan tidak benar.
