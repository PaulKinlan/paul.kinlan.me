...
Un poco atrás, creé un script `[waitForElement](/waiting-for-an-element-to-be-created)` que ... Pensé que estaba siendo genial, pero resultó que estaba usando Promises incorrectamente.
