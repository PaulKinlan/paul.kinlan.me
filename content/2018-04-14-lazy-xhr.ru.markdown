...
Немного назад, я создал скрипт `[waitForElement](/waiting-for-an-element-to-be-created)`, который бы ... Я думал, что я был классным, но оказалось, что я неправильно использовал обещания.
