...
Vor ein paar Minuten habe ich ein Skript `[waitForElement](/waiting-for-an-element-to-be-created)` erstellt, das würde ... Ich dachte, ich wäre cool, aber es stellte sich heraus, dass ich Promises falsch verwendete.
