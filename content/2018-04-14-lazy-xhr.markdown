...
A little ways back, I created a script `[waitForElement](/waiting-for-an-element-to-be-created)`
that would... I thought I was being cool but it turned out I was using Promises incorrectly.
