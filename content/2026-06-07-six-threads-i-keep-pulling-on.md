---
date: 2026-06-07T14:17:06.325Z
draft: true
slug: where-my-head-is-at-with-llms
summary: 
  Where my head is at with LLMs
tags:
- ai
- web platform
- agents
...
- llm
- agent-do
title: Where my head is at with LLMs
---

I have been writing a lot over at [aifoc.us](https://aifoc.us/) for the past year and I've spent a lot of time exploring the risks and opportunities for the web, and challenges that we face as an an ecosystem that I think we need to adapt to.

I kept it distinct from this site because I know that quite a few web developers who are not fond (to put it mildly) of LLMs and the AI industrial complex follow my content and I felt it would be good to split the two.
...
I what to explore more about addressable unit of the web should look like for agents and building on [SLICE](https://paul.kinlan.me/slice-the-web/) and how this might evolve. Naturally, there is a lot of worry about the I in SLICE that I want to explore a little bit more.
...
Once you have written a few agents you see that we have a new pattern for software (that people call agent-loops). It is slower and vastly more expensive, but also it's opening up a world where it's easier and easier for people to instruct their machines and get accurate results. It's rather incredible and it reminds of how much more approachable HTML was when I started.

I built my own provider-agnostic loop and wrote it up in [agent-do](https://aifoc.us/agent-do-my-agent-loop/) and it enables me to do a *lot* of experiementation, for example: 
...
I know I linked to these above, but the browser sandbox and "agent-loops", I think are going to change a lot about how web experiences could be built in the future. I don't think we are there yet, but I can imagine a world where entire web sites and services are higher-level instructions and design guidance.
...
I'm personally fully on-board with these tools and I think I've become quite proficient and while I do encourage people to understand how the platform works and how the browser works, I don't think we are going back at all, in fact everything will accelerate now that the technology and tools exist.
...
I'm personally kind of shocked there isn't more experimentation about how the future of sites and browsers might work. With tools that generate content getting higher-quality and quicker it is going to open up new areas of the platform:

* If we can [intercept](https://aifoc.us/interception/) requests to synthesise responses, what does it enable?
* If we take [hypermedia](https://aifoc.us/hypermedia/) to the extreme and enable any content to be turned in to experiences that people prefer, what will happen? I know a lot of folks who learn via Managa, why shouldn't they be able to consume in their preferred format.
* I think we now have the Memex, so what happens to the [CMS](https://aifoc.us/whither-cms/) when content is generated (hint: they can adapt) and also markup can change to be more expressive ([Headless stopgap](https://aifoc.us/headless-stopgap/))

There's going to be even more change to the web with the falling [latency](https://aifoc.us/latency/) of models that will make generating UI and new content modalities on the fly viable (and I think sites should lean into generating content for how their users prefer).
...
If Browser vendors choose, they could solve interop issues once and for all. In  [how might a browser be developed](https://aifoc.us/how-might-a-browser-be-developed/) to the point where the major points of interop differences are on the fundamental issues of where the browser vendor thinks the web should go. I explore this, but I also go a little further out into some sci-fi.
