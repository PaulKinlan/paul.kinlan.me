...
Un poco más atrás, creé un script `[waitForElement](/ waiting-for-a-element-to-be-created)` que ... Pensé que estaba siendo genial pero resultó que estaba usando Promises incorrectamente .
